...
teams = Team.create!([
  ...
  { name: 'Bournemouth', league: leagues[0] },
  ...
  { name: 'Nottingham Forest', league: leagues[0] },
  ...
  # Ligue 1:
  { name: 'Ajaccio', league: leagues[2] },
  { name: 'Angers', league: leagues[2] },
  { name: 'Auxerre', league: leagues[2] },
